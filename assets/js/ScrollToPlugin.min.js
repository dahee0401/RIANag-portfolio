        ...
        r = {
            ...
            init: function init(e, r, l, s, i) {
                ...
                (p.isWin = e === T),
                    ...
                    c &&
                        'none' !== c &&
                        ((p.snap = 1), (p.snapInline = e.style.scrollSnapType), (e.style.scrollSnapType = 'none')),
                    null != r.x
                        ? (p.add(p, 'x', p.x, t(r.x, e, 'x', p.x, r.offsetX || 0), s, i), p._props.push('scrollTo_x'))
                        : (p.skipX = 1),
                    null != r.y
                        ? (p.add(p, 'y', p.y, t(r.y, e, 'y', p.y, r.offsetY || 0), s, i), p._props.push('scrollTo_y'))
                        : (p.skipY = 1);
            },
